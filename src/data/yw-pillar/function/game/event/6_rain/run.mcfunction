...
execute as @a[tag=ingame,tag=!out] at @s run summon arrow ~ ~6 ~ {Tags:["event.6_rain","center"],Motion:[0,-0.3,0],crit:true,life:600,Passengers:[{id:"item_display",item:{id:"stone_sword"},transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,2.5f,1f],scale:[1f,1f,1f],right_rotation:[0f,0f,0f,1f]},Tags:["event.6_rain","center"]}]}
...
execute as @e[type=arrow,tag=event.6_rain,tag=!center] run function yw-pillar:utils/event/random_arrow with entity @s