...
execute if score @s TriggerSetting.Map matches 3 run data modify storage yw-pillar:settings game merge value {previous:2,current:3,next:3,map_name:"岩浆",map_id:lava}
