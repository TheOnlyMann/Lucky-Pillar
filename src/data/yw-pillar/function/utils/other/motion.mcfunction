...
$tp @e[type=marker,distance=..1,tag=mr.motion,limit=1] ^ ^ ^$(scale)
...
execute store result storage yw-pillar:temp motion.x double 0.001 run scoreboard players get $Motion2 Pos.X
execute store result storage yw-pillar:temp motion.y double 0.001 run scoreboard players get $Motion2 Pos.Y
execute store result storage yw-pillar:temp motion.z double 0.001 run scoreboard players get $Motion2 Pos.Z
