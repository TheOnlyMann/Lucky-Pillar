...
# 牛肉
execute if score @s YanPai matches 1 run tellraw @a ["",{text:"[Tips]",color:"gold",bold:true},{selector:"@s",bold:true},{text:"验出了",color:"yellow"},{sprite:"item/apple",atlas:"items",object:"atlas"},"x5"]
